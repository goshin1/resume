...
function ScrollToSection() {
  ...
  return (
    <div id='rootBody'>
      <div id='rootBtn'>
        <button onClick={() => scrollToSection(sectionOneRef)}>Home</button>
        <button onClick={() => scrollToSection(sectionTwoRef)}>About</button>
        <button onClick={() => scrollToSection(sectionThreeRef)}>Project</button>
      </div>
